...
function complete_option_defaults() {
	$defaults = array(
		...
		'header_layout_id' => 'header_layout4',
		'center_width' => 83.50,
		...
		'totop_id' => '1',
		'footer_text_id' => __('&copy; Copyright 2019. Fashion. All Rights Reserved. Designed by SKT Themes', 'complete'),
        ...
        'slide_title1' => 'DISCOVER<small>NEW FASHION TRENDS</small>',
        'slide_desc1' => '',
        'slide_link1' => '#',
        'slide_btn1' => 'SHOP NOW',
        
        'slide_image2' => ''.get_template_directory_uri().'/images/slides/slider2.jpg',
        'slide_title2' => 'DISCOVER<small>NEW FASHION TRENDS</small>',
        'slide_desc2' => '',
        'slide_link2' => '#',
        'slide_btn2' => 'SHOP NOW',
        
        'slide_image3' => ''.get_template_directory_uri().'/images/slides/slider3.jpg',
        'slide_title3' => 'DISCOVER<small>NEW FASHION TRENDS</small>',
        'slide_desc3' => '',
        'slide_link3' => '#',
        'slide_btn3' => 'SHOP NOW',
		...
		'mobbgtop_color_id' => '#fda8ad',
		'mobmenutxt_color_id' => '#ffffff',
		'mobmenutxt_active_color_id' => '#fda8ad',
		...
		'logo_image_height' => '63px;',
		'logo_image_width' => '172px;',
		...
		'sldtitle_font_id' => array('font-family' => 'Poppins', 'font-size' => '140px'),
		...
		'testimonial_activepager_color_id' => '#fda8ad',
		...
		'header_mobile_number' => '<i class="fa fa-phone" aria-hidden="true"></i><span class="header-phone"><small>NEED HELP?</small>123 - 456 - 7890</span>',
		...
		'header_icons_color' => '#282828',
		'header_icons_hover_color' => '#fda8ad',
		'menu_background_color' => '#f0969b',
		'menu_toggle_background_color' => '#fda8ad',
		...
		'perfect_hover_border_color' => '#fda8ad',
 
		'foot_layout_id' => '4',
		'footer_color_id' => '#1a1a1a',
		'footer_bg_image' => '',
		'footwdgtxt_color_id' => '#bcbbbb',
		'footer_title_color' => '#ffffff',
		'footer_title_border_color' => '#fda8ad',
		...
		'footer_menu_hover_color' => '#fda8ad',
		...
		'featured_block_button_bg' => '#fda8ad',
		'featured_block_hover_button_bg' => '#393939',
		
		//Footer Column 1
		'foot_cols1_title' => __('ABOUT FASHION', 'complete'),
