<?php 
/**
 * The Custom Style for SKT Ele Fashion Lite
 *
...
/*-----------------------------COLORS------------------------------------*/
		...
		.header-extras li a,
		.header-extras li .header-search-toggle{color: <?php echo $complete['header_icons_color'] ?>;}
		.header-extras li a:hover,
		.header-extras li .header-search-toggle:hover{color: <?php echo $complete['header_icons_hover_color']; ?>;}
		.header-extras li .custom-cart-count{background-color: <?php echo $complete['header_icons_hover_color']; ?>;}
		
		.header-phone-number{color: <?php echo $complete['header_icons_color'] ?>;}
		
		/*MENU Text Color*/
		.header-menu-open, .header-menu-close{background-color: <?php echo $complete['menu_toggle_background_color']; ?>;}
		.header .centerlogoarea{background-color: rgba(<?php echo complete_hex2rgb($complete['menu_background_color']);?>, 0.85);}
